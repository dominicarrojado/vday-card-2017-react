...
WebApp.connectHandlers.use('/', Meteor.bindEnvironment((req, res, next) => {
    ...
    if (card) {
        meta = `
            <meta property="og:title" content="Hey ${card.to}, you have a e-card from ${card.from}!">
            ...
            <meta property="og:image" content="${Meteor.absoluteUrl(`images/sharer/cover-${card.cover}.png`)}">
        ...
        meta = `
            ...
            <meta property="og:image" content="${Meteor.absoluteUrl('images/sharer/hashtag-interactive-to-my-valentine.png')}">
