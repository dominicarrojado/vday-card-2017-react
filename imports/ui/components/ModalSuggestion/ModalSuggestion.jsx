        ...
        <div id="modalSuggestion" className="modal">
          <div className="dialog">
            <div className="wrapper">
              <button onClick={SuggestionModal.hide} className="btn-close">
                &times;
              </button>
              <div className="header">
                Can't think of a message?
                <br />
                Pick one from here!
              </div>
              <ul className="suggestions">
                {getMessages().map((message, index) => {
                  return (
                    <li
                      key={index}
                      onClick={() => SuggestionModal.messageOnClick(message)}
          ...
          <div onClick={SuggestionModal.hide} className="backdrop" />
        </div>
